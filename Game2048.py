...
class Game2048(object):
    ...
    def Paint(self):
        ...
        self.title_font = pygame.font.SysFont('nsimsun', 50, True)
        ...
        self.score_font = pygame.font.SysFont('nsimsun', 28, True)
        ...
        # 添加游戏说明
        self.tips_font = pygame.font.SysFont('nsimsun', 20)
        ...
        for i in range(4):
            for j in range(4):
                ...
                # 数字字体即大小
                if value < 10:
                    self.font = pygame.font.SysFont('nsimsun', 46, True)  # 数字2、4、8
                    value_text = self.font.render(str(value), True, self.nums_color[value])
                    self.form.blit(value_text, (x + 35, y + 120))
                elif value < 100:
                    self.font = pygame.font.SysFont('nsimsun', 40, True)  # 数字16, 32, 64
                    value_text = self.font.render(str(value), True, self.nums_color[value])
                    self.form.blit(value_text, (x + 25, y + 120))
                elif value < 1000:
                    self.font = pygame.font.SysFont('nnsimsun', 34, True)  # 数字128, 256, 512
                    value_text = self.font.render(str(value), True, self.nums_color[value])
                    self.form.blit(value_text, (x + 15, y + 120))
                else:
                    self.font = pygame.font.SysFont('nsimsun', 28, True)  # 数字1024, 2048
                    value_text = self.font.render(str(value), True, self.nums_color[value])
        ...
        if self.is_over:
            over_font = pygame.font.SysFont("nsimsun", 60, True)
        ...
        if self.is_success:
            success_font = pygame.font.SysFont("nsimsun", 60, True)
